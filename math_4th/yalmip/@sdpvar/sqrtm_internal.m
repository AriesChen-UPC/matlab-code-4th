...
% $Id: sqrtm_internal.m,v 1.7 2007/08/02 18:16:26 joloef Exp $
switch class(varargin{1})
    ...
    case 'char'
        ...
        varargout{1} = F;
        varargout{2} = struct('convexity','concave','monotonicity','increasing','definiteness','positive','convexhull',@convexhull,'bounds',@bounds,'model','callback');
        varargout{3} = X;
